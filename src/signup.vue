      ...
      <div class="max-w-5xl mx-auto">
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            <div class="max-w-md">
              <span class="text-lg text-4xl text-blue-400 font-bold">Register Account</span>
              <h2 class="mt-8 mb-12 text-5xl font-bold font-heading text-white">Welcome to Invoice-Track</h2>
              <p class="text-lg text-gray-200">
                <span>Already have an account?</span>
                <router-link class="text-blue-500 hover:underline" to="/login" data-config-id="extra-action"> Login</router-link>
              </p>
            </div>
          </div>
